            ...
            success: function(data) {
                ...
                data.forEach(function(user, index) {
                    tbody += `<tr>
                        ...
                        <td>${user.date}</td>
                        <td>
                            <button class="btn btn-primary btn-md edit-user" data-id="${user.id}"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger btn-md delete-user" data-id="${user.id}"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>`;
                });
